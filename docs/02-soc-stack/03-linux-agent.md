# Phase 2 — Part 3: SOC Stack Linux Agent + auditd
...
*Previous: [Phase 2 — Part2: SOC Stack Windows Agents + Sysmon](02-windows-agent.md)*
*Next: [Phase 2 — Part 4: SOC Stack pfSense Syslog Integration](04-pfsense-syslog.md)*
