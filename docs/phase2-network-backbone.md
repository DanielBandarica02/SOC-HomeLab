...
| [![DNS Resolver DNSSEC unchecked](../screenshots/phase2/06-dns-resolver-dnssec-unchecked.png)](../screenshots/phase2/04-dns-resolver-dnssec-unchecked.png) | `Services → DNS Resolver` — `Enable DNSSEC Support` unchecked |
| [![Ping google.com success](../screenshots/phase2/07-diagnostics-ping-google-success.png)](../screenshots/phase2/05-diagnostics-ping-google-success.png) | `Diagnostics → Ping → google.com` — DNS works after DNSSEC disabled |
| [![Suricata Interface](../screenshots/phase2/08-suricata-install-success.png)](../screenshots/phase2/06-suricata-interface.png) | `Package Manager` — Suricata Interface |
