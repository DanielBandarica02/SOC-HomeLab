...
![Query Returns SSH](../screenshots/phase6/queryreturnsssh.png)
![Wazuh Dashboard](../screenshots/phase2/wazuhdashboard.png)
...
- `screenshots/phase6/01-ssh-bruteforce-splunk-table.png` — Enriched SPL query result
---
